...
export default defineConfig(({ mode }) => {
  ...
  // On récupère les valeurs avec une priorité absolue aux variables système (Cloudflare/process.env)
  ...
  return {
    plugins: [react()],
    define: {
      // Cette étape remplace statiquement les appels import.meta.env dans le code source lors du build
      ...
      // On expose aussi via process.env pour une compatibilité maximale
