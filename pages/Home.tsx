...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full bg-white">
      {/* Hero Section */}
      <section className="relative min-h-[calc(100vh-80px)] flex items-center py-20 overflow-hidden bg-[#0c4a6e]">
        <div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="flex flex-col items-center text-center">
            <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-white/5 backdrop-blur-2xl border border-white/10 text-white text-[10px] font-black uppercase tracking-[0.3em] mb-8 md:mb-12 shadow-2xl animate-in fade-in slide-in-from-top">
              <Sparkles className="w-3.5 h-3.5 text-brand-500" />
              L'excellence à portée de main
            </div>
            
            <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-serif font-bold text-white leading-[1.1] mb-8 md:mb-10 max-w-5xl tracking-tight drop-shadow-2xl px-4 animate-in fade-in zoom-in-95">
              Propulsez votre salon <br /> vers <span className="text-brand-500 italic font-normal">l'excellence</span>
            </h1>
            
            <p className="text-lg md:text-2xl text-slate-200 mb-10 md:mb-14 leading-relaxed max-w-3xl font-medium opacity-90 px-6 animate-in fade-in slide-in-from-bottom">
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full sm:w-auto px-6 animate-in fade-in slide-in-from-bottom">
              {user ? (
                <>
                  <Link
                    to="/caisse"
                    className="bg-emerald-500 text-white px-10 md:px-14 py-5 md:py-6 rounded-2xl font-black text-xs uppercase tracking-[0.25em] shadow-2xl shadow-emerald-500/20 hover:bg-emerald-600 hover:-translate-y-1 transition-all flex items-center justify-center gap-4 group"
                  >
                  ...
                  <Link
                    to="/dashboard"
                    className="bg-white/10 backdrop-blur-xl text-white border border-white/20 px-10 md:px-14 py-5 md:py-6 rounded-2xl font-black text-xs uppercase tracking-[0.25em] hover:bg-white/20 hover:-translate-y-1 transition-all flex items-center justify-center"
                  >
                    Tableau de bord
                  </Link>
                </>
      ...
      {/* Stats Section */}
      <section className="relative z-20 -mt-16 md:-mt-24 px-4 w-full">
